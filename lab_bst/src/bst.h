...
class BST
{
  ...
  private:
    ...
    */
    ...
    /**
     * Helper function to get the in order predecessor of any node
     * @param toad  The node that we want the predecessor of
     * @return a pointer reference to the in order predecessor
     */
    Node* & getPredecessor(Node* toad);
